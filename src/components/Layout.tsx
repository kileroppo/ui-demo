...
import { Menu, X, Sun, Moon, Home, Palette, Sparkles, Package, PenTool, FolderOpen, Clock, Camera } from 'lucide-react'
...
const BOTTOM_NAV_ITEMS = [
  ...
  { path: '/image-match', label: '图片匹配', icon: Camera },
