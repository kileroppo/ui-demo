        ...
        <nav className="mb-6 flex flex-wrap gap-2" aria-label="产品分类导航">
          {categoryNames.map((cat) => (
            <a
              key={cat}
              href={`#category-${cat}`}
              className="px-3 py-1.5 text-sm rounded-full bg-white border border-gray-200 text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 hover:border-indigo-200 transition-colors"
            >
